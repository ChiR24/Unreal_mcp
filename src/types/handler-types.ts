...
// NOTE: PCGArgs interface is defined later in this file (around line 1297) with comprehensive fields.
// See the "Arguments for manage_pcg tool (Phase 27)" section below.
