...
export const ANIM_AUTHORED_1: readonly CapabilityRecordSource[] = [
  ...
  buildRecord({ parentTool: T, id: `${T}.set_transition_rules`, action: 'set_transition_rules', family: F,
    ...
    inputProps: { action: P.action, assetPath: P.assetPath, blueprintPath: P.blueprintPath, stateMachineName: A.stateMachineName, fromState: P.fromState, toState: P.toState, blendTime: P.blendTime, conditionVariable: A.conditionVariable, conditionComparison: A.conditionComparison, conditionValue: A.conditionValue }, required: ['action'],
