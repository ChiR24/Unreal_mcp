...
export const MEDIA_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, name: P.name, path: P.path, sourceType: P.property, filePath: P.filePath, url: P.url },
    required: ['action', 'name', 'path'],
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, name: P.name, path: P.path, mediaPlayerPath: P.mediaPlayerPath },
    required: ['action', 'name', 'path'],
    effect: 'write', latency: 'interactive', resources: 'low', plugins: MEDIA_PLUGINS,
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, playerPath: P.playerPath, mediaSourcePath: P.mediaSourcePath, sourcePath: P.sourcePath, playlistPath: P.playlistPath, url: P.url, filePath: P.filePath },
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, playerPath: P.playerPath, seekTime: { type: 'number', description: 'Seek time in seconds.' } },
