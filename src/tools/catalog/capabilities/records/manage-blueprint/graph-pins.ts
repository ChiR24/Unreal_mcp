...
export const GRAPH_PINS_RECORDS: readonly CapabilityRecordSource[] = [
  buildRecord({
    ...
    inputProps: { action: P.action, blueprintPath: P.blueprintPath, graphName: P.graphName, fromNodeId: P.fromNodeId, fromPinName: P.fromPinName, toNodeId: P.toNodeId, toPinName: P.toPinName },
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, blueprintPath: P.blueprintPath, graphName: P.graphName, nodeId: P.nodeId, pinName: P.pinName },
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, blueprintPath: P.blueprintPath, graphName: P.graphName, nodeId: P.nodeId, propertyName: P.propertyName, propertyValue: P.propertyValue },
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, blueprintPath: P.blueprintPath, graphName: P.graphName, nodeId: P.nodeId, pinName: P.pinName, propertyValue: P.propertyValue },
    required: ['action', 'blueprintPath', 'nodeId', 'pinName'],
    effect: 'write',
    behavior: { idempotency: 'idempotent', safeToRetry: true },
    latency: 'instant',
