...
export const WIDGET_LAYOUT_RECORDS: readonly CapabilityRecordSource[] = [
  layout('set_anchor', 'blueprint.set_anchor', 'Set the anchor points (min/max) for a widget in a canvas panel slot.', { anchorMin: P.anchorMin, anchorMax: P.anchorMax }, ['anchorMin', 'anchorMax']),
  ...
  layout('set_render_transform', 'blueprint.set_render_transform', 'Set the render transform (translation, shear, angle) for a widget.', { translation: P.translation, shear: P.shear, angle: P.angle }),
  ...
  layout('set_style', 'blueprint.set_style', 'Set the visual style (color, font, brush) for a widget.', { colorAndOpacity: P.colorAndOpacity, fontSize: P.fontSize }),
