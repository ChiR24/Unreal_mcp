...
export const SCS_COMPONENTS_RECORDS: readonly CapabilityRecordSource[] = [
  buildRecord({
    ...
    inputProps: { action: P.action, blueprintPath: P.blueprintPath, componentClass: P.componentClass, componentName: P.componentName },
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, blueprintPath: P.blueprintPath, componentClass: P.componentClass, componentName: P.componentName, parentComponent: P.parentComponent },
    required: ['action', 'blueprintPath', 'componentClass'],
    outputProps: {
