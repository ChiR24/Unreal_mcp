...
export const SYSTEM_OPS_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildCoreRecord({
    ...
    inputProps: {
      ...
      runsBack: { type: 'number', description: 'With source previous: how many editor runs back to read (default 1, max 20). After a crash and one more restart, the crashed run is 2.' },
    },
    required: [],
    outputProps: {
