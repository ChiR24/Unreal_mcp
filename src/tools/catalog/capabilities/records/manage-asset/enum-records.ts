...
export const ENUM_RECORDS: readonly RecordSpec[] = [
  ...
  r('delete_enum', 'enum', 'Delete a UserDefinedEnum asset.', schema({ enumPath: ENUM_PATH }, ['enumPath']), OK, DESTRUCTIVE, DESTRUCTIVE_POLICY, LOW, { dispatchMode: 'tool' }),
  ...
  r('remove_enum_value', 'enum', 'Remove a value from a UserDefinedEnum.', schema({ enumPath: ENUM_PATH, valueName: VALUE_NAME }, ['enumPath', 'valueName']), OK, DESTRUCTIVE, DESTRUCTIVE_POLICY, LOW, { dispatchMode: 'tool' }),
