...
export const DATATABLE_RECORDS: readonly RecordSpec[] = [
  ...
  r('delete_data_table_row', 'datatable', 'Delete a row from a DataTable.', schema({ dataTablePath: DT_PATH, rowName: ROW_NAME }, ['dataTablePath', 'rowName']), OK, DESTRUCTIVE, DESTRUCTIVE_POLICY, LOW, { dispatchMode: 'tool' }),
  ...
  r('clear_data_table_rows', 'datatable', 'Clear all rows from a DataTable.', schema({ dataTablePath: DT_PATH }, ['dataTablePath']), OK, DESTRUCTIVE, DESTRUCTIVE_POLICY, LOW, { dispatchMode: 'tool' })
];
