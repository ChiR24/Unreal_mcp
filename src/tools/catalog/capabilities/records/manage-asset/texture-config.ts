...
export const TEXTURE_CONFIG_RECORDS: readonly RecordSpec[] = [
  ...
  r('set_streaming_priority', 'texture', 'Set streaming priority and never-stream on a texture.', schema({ assetPath: str('Texture /Game path.'), neverStream: bool('Never stream this texture.'), save: bool('Save after change.') }, ['assetPath']), OK, WRITE, WRITE_POLICY, LOW, { dispatchMode: 'tool' }),
