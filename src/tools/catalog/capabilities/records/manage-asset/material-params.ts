...
export const MATERIAL_PARAMS_RECORDS: readonly RecordSpec[] = [
  ...
  r('get_material_info', 'material', 'Retrieve material information.', schema({ assetPath: MAT }, ['assetPath']), OK, READ, READ_POLICY, LOW,
    { dispatchMode: 'tool', examples: [ex('Read a material\'s configuration', { assetPath: M }, DONE)] }),
