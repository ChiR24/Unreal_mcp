...
export const SPLINE_RECORDS: readonly CapabilityRecordSource[] = [
  buildRecord({
    ...
    inputProps: { action: P.action, name: P.name, location: P.location, rotation: P.rotation, points: P.points, bClosedLoop: P.bClosedLoop },
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, actorName: P.actorName, actorPath: P.actorPath, componentName: P.componentName, meshPath: P.meshPath, forwardAxis: P.forwardAxis },
    required: ['action'], effect: 'write', latency: 'interactive', resources: 'low',
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, actorName: P.actorName, actorPath: P.actorPath, spacing: P.spacing },
    required: ['action'], effect: 'write', behavior: { idempotency: 'idempotent' }, latency: 'interactive', resources: 'low',
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, actorName: P.actorName, actorPath: P.actorPath,
