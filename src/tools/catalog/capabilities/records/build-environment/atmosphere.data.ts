...
export const ATMOSPHERE_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, settings: P.actorSettings, intensity: P.intensity },
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, skyLightIntensity: P.skyLightIntensity, cubemapPath: P.cubemapPath, settings: P.actorSettings },
    required: ['action'], effect: 'write', behavior: { idempotency: 'idempotent' }, latency: 'interactive', resources: 'low',
  ...
  buildRecord({
    ...
    whenToUse: WU, whenNotToUse: ['Default atmosphere is sufficient.'],
    inputProps: { action: P.action, actorName: P.actorName, azimuth: P.azimuth, elevation: P.elevation, intensity: P.intensity, settings: P.actorSettings },
    required: ['action'], effect: 'write', behavior: { idempotency: 'idempotent' }, latency: 'interactive', resources: 'low',
  ...
  buildRecord({
    ...
    inputProps: { action: P.action, settings: P.actorSettings, density: P.density },
    required: ['action'], effect: 'write', behavior: { idempotency: 'idempotent' }, latency: 'interactive', resources: 'low',
