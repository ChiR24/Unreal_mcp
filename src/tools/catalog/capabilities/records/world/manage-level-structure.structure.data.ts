...
export const LEVEL_STRUCTURE_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildWorldRecord({
    ...
    inputProps: { sublevelPath: P.sublevelPath, streamingMethod: P.streamingMethod, bShouldBeVisible: P.bShouldBeVisible, bShouldBlockOnLoad: P.bShouldBlockOnLoad, bDisableDistanceStreaming: P.bDisableDistanceStreaming, save: P.save },
    required: ['sublevelPath'], effect: 'write', costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'configure_level_streaming', sublevelPath: '/Game/Maps/Sub01', streamingMethod: 'Blueprint' },
  ...
  buildWorldRecord({
    ...
    inputProps: { volumeLocation: P.volumeLocation, sublevelPath: P.sublevelPath, streamingDistance: P.streamingDistance, streamingUsage: P.streamingUsage, createVolume: P.createVolume, save: P.save },
    required: ['sublevelPath', 'streamingDistance'], effect: 'write', costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'set_streaming_distance', sublevelPath: '/Game/Maps/Sub01', streamingDistance: 5000 },
  ...
  buildWorldRecord({
    ...
    inputProps: { levelPath: P.levelPath, bEnableWorldPartition: P.bEnableWorldPartition, bUseExternalActors: P.bUseExternalActors, save: P.save },
    required: ['levelPath'], effect: 'write', costLatency: 'interactive', costResources: 'medium',
    exampleInput: { action: 'enable_world_partition', levelPath: '/Game/Maps/Demo' },
  ...
  buildWorldRecord({
    ...
    inputProps: { gridName: P.gridName, createIfMissing: P.createIfMissing, bBlockOnSlowStreaming: P.bBlockOnSlowStreaming, levelPath: P.levelPath, gridCellSize: P.gridCellSize, loadingRange: P.loadingRange, save: P.save },
    required: ['levelPath'], effect: 'write', behavior: { idempotency: 'idempotent' }, costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'configure_grid_size', levelPath: '/Game/Maps/Demo', gridCellSize: 12800 },
