...
export const GEOMETRY_OPERATIONS_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, amount: P.amount, targetActor: P.targetActor, offset: P.offset , triangleIndices: { type: 'array', items: { type: 'integer' }, description: 'Triangle ids the operation is limited to; omit to apply it to the whole mesh.' } }, required: ['targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, distance: P.distance, targetActor: P.targetActor , triangleIndices: { type: 'array', items: { type: 'integer' }, description: 'Triangle ids the operation is limited to; omit to apply it to the whole mesh.' } }, required: ['targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor , triangleIndices: { type: 'array', items: { type: 'integer' }, description: 'Triangle ids the operation is limited to; omit to apply it to the whole mesh.' } }, required: ['targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, offset: P.offset , triangleIndices: { type: 'array', items: { type: 'integer' }, description: 'Triangle ids the operation is limited to; omit to apply it to the whole mesh.' } }, required: ['targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
