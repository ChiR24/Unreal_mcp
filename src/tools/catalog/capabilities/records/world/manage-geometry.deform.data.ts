...
export const GEOMETRY_DEFORM_RECORDS: readonly CapabilityRecordSource[] = [
  buildWorldRecord({
    ...
    exampleInput: { action: 'bend', targetActor: 'DM_A', axis: 'X', strength: 30 }, exampleOutput: { success: true, message: 'Bend complete' },
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, axis: P.axis, strength: P.strength }, required: ['axis'], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'twist', targetActor: 'DM_A', axis: 'Z', strength: 45 }, exampleOutput: { success: true, message: 'Twist complete' },
    normalizationRationale: NR,
  }),
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, axis: P.axis, strength: P.strength }, required: ['axis'], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'taper', targetActor: 'DM_A', axis: 'Y', strength: 20 }, exampleOutput: { success: true, message: 'Taper complete' },
    normalizationRationale: NR,
  }),
  buildWorldRecord({
