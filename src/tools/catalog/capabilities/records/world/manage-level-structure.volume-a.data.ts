...
export const LEVEL_VOLUME_A_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildWorldRecord({
    ...
    exampleInput: { action: 'add_trigger_volume', location: { x: 0, y: 0, z: 0 } },
  ...
  buildWorldRecord({
    ...
    inputProps: { volumeName: P.volumeName, location: P.location, extent: P.extent, save: P.save },
    required: ['location'], effect: 'write', costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'add_blocking_volume', location: { x: 0, y: 0, z: 0 } },
  ...
  buildWorldRecord({
    ...
    inputProps: { volumeName: P.volumeName, location: P.location, extent: P.extent, save: P.save },
    required: ['location'], effect: 'write', costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'add_kill_z_volume', location: { x: 0, y: 0, z: -1000 } },
  ...
  buildWorldRecord({
    ...
    inputProps: { volumeName: P.volumeName, location: P.location, extent: P.extent, save: P.save },
    required: ['location'], effect: 'write', costLatency: 'interactive', costResources: 'low',
    exampleInput: { action: 'add_physics_volume', location: { x: 0, y: 0, z: 0 } },
