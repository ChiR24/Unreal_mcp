  ...
  },
  {
    ...
    outputSchema: {
      ...
      properties: {
        ...
        socketName: commonSchemas.socketName,
        meshes: commonSchemas.arrayOfObjects,
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        name: commonSchemas.name,
        path: commonSchemas.directoryPathForCreation,
        lodIndex: commonSchemas.integerProp,
        qualityLevel: { type: 'string', enum: ['Low', 'Medium', 'High', 'Epic', 'Cinematic'], description: 'Quality level to configure.' },
        simplifyNodes: { type: 'boolean', description: 'Whether to simplify nodes for this LOD.' },
