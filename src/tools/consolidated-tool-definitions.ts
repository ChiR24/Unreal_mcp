  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        // Enum/Struct authoring (create_enum, create_struct, modify_enum, modify_struct, inspect_enum, inspect_struct)
        assetPath: commonSchemas.assetPath,
        enumerators: commonSchemas.arrayOfObjects,
        members: commonSchemas.arrayOfObjects,
        overwrite: commonSchemas.booleanProp,
        includeGuids: commonSchemas.booleanProp
      },
      required: ['action']
    },
    outputSchema: {
