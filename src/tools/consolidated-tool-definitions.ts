    ...
    inputSchema: {
      ...
      properties: {
        action: {
          ...
          enum: [
            // Value Tracker
            'create_value_tracker', 'modify_value', 'set_value', 'get_value', 'add_value_threshold', 'configure_value_decay', 'configure_value_regen', 'pause_value_changes',
            // State Machine
            'create_actor_state_machine', 'add_actor_state', 'add_actor_state_transition', 'set_actor_state', 'get_actor_state', 'configure_state_timer',
            // Faction
            'create_faction', 'set_faction_relationship', 'assign_to_faction', 'get_faction', 'modify_reputation', 'get_reputation', 'add_reputation_threshold', 'check_faction_relationship',
            // Attachment
            'attach_to_socket', 'detach_from_parent', 'transfer_control', 'configure_attachment_rules', 'get_attached_actors', 'get_attachment_parent',
            // Schedule
            'create_schedule', 'add_schedule_entry', 'set_schedule_active', 'get_current_schedule_entry', 'skip_to_schedule_entry',
            // World Time
            'create_world_time', 'set_world_time', 'get_world_time', 'set_time_scale', 'pause_world_time', 'add_time_event', 'get_time_period',
            // Zone
            'create_zone', 'set_zone_property', 'get_zone_property', 'get_actor_zone', 'add_zone_enter_event', 'add_zone_exit_event',
            // Condition
            'create_condition', 'create_compound_condition', 'evaluate_condition', 'add_condition_listener',
            // Interaction
            'add_interactable_component', 'configure_interaction', 'set_interaction_enabled', 'get_nearby_interactables', 'focus_interaction', 'execute_interaction',
            // Spawner
            'create_spawner', 'configure_spawner', 'set_spawner_enabled', 'configure_spawn_conditions', 'despawn_managed_actors', 'get_spawned_count'
          ],
          description: 'Gameplay primitive action'
        },
        // Common
        actorName: commonSchemas.actorName,
        save: commonSchemas.save,
        ...
        conditions: { description: 'Conditions JSON or object' },
        
        // World Time
        initialHour: { type: 'number' },
        initialMinute: { type: 'number' },
        dayLengthSeconds: { type: 'number' },
        hour: { type: 'number' },
        minute: { type: 'number' },
        ...
        factionA: { type: 'string' },
        factionB: { type: 'string' },
        ...
        leftOperand: { type: 'object' },
        operator: { type: 'string' },
        rightOperand: { type: 'object' },
        compoundType: { type: 'string' },
        childConditions: commonSchemas.arrayOfStrings,
        triggerOnce: { type: 'boolean' },
        
        // Interaction
        interactionType: { type: 'string' },
        interactionPrompt: { type: 'string' },
        interactionRange: { type: 'number' },
        interactionPriority: { type: 'number' },
        enabled: commonSchemas.enabled,
        focused: { type: 'boolean' },
        focusingActorName: { type: 'string' },
        interactingActorName: { type: 'string' },
        radius: commonSchemas.radius,
        ...
        activeDays: commonSchemas.arrayOfNumbers,
        active: { type: 'boolean' },
        
        // Spawner
        spawnClassPath: { type: 'string' },
        maxCount: { type: 'number' },
        conditionsJson: { type: 'string' },
        
        // Attachment
        parentActorName: commonSchemas.parentActorName,
        socketName: commonSchemas.socketName,
        attachRule: { type: 'string' },
        detachRule: { type: 'string' },
        newOwnerName: { type: 'string' },
        weldSimulatedBodies: { type: 'boolean' },
        locationRule: { type: 'string' },
        rotationRule: { type: 'string' },
        scaleRule: { type: 'string' },
        newParentActorName: { type: 'string' }
      },
      required: ['action']
    },
    outputSchema: {
      ...
      properties: {
        ...
        value: commonSchemas.value,
        state: commonSchemas.stringProp,
        faction: commonSchemas.stringProp,
        zoneId: commonSchemas.stringProp
      }
    }
  }
