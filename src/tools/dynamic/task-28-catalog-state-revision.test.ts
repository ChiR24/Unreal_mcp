...
//   npx vitest run src/tools/dynamic/task-28-catalog-state-revision.test.ts -t 'Task 28 baseline'
//   npx vitest run src/tools/dynamic/task-28-catalog-state-revision.test.ts -t 'Task 28 desired'
//
