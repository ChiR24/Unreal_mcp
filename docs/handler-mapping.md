...
| `get_graph_review_summary` | `McpAutomationBridge_BlueprintGraphHandlers.cpp`    | `HandleBlueprintGraphAction` | First-pass summary plus bounded `nodeId` follow-up via `focusedReviewTarget`, `incomingNodes`, and `outgoingNodes` |
...
| `capture_blueprint_graph_review` | `McpAutomationBridge_ControlHandlers.cpp`        | `HandleControlEditorCaptureBlueprintGraphReview` | Supports `scope: neighborhood` readable capture around a matched node |
...
| `console_command`             | `McpAutomationBridge_EditorFunctionHandlers.cpp` | `HandleConsoleCommandAction`  |                                         |
| `run_ubt`                     | _None_                                           | _None_                        | Handled in TypeScript (`child_process`) |
...
| `set_replication_condition`      | `McpAutomationBridge_NetworkingHandlers.cpp` | `HandleManageNetworkingAction` | Sets COND\_\* replication condition    |
...
| `set_net_dormancy`               | `McpAutomationBridge_NetworkingHandlers.cpp` | `HandleManageNetworkingAction` | Sets DORM\_\* dormancy mode            |
