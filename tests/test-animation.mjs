...
const testCases = [
  ...
  { scenario: 'Anim Setup - Create Montage', toolName: 'animation_physics', arguments: { action: 'create_animation_asset', name: 'AM_Setup', skeletonPath: '/Game/Characters/SK_Mannequin_Skeleton', savePath: '/Game/Animations', assetType: 'montage' }, expected: 'success' },
  { scenario: 'Anim Setup - Add Notify', toolName: 'animation_physics', arguments: { action: 'add_notify', assetPath: '/Game/Animations/AM_Setup', notifyName: 'PlaySound', time: 0.5 }, expected: 'success' },
