...
const testCases = [
  ...
  { scenario: 'GT: list tags including new source', toolName: 'manage_gameplay_tags',
    ...
    expected: 'success' },
  // Ch6: manage_widget_authoring — generic add_widget / remove_widget escape hatch
  { scenario: 'UMG prep: create WBP parent (WBP_Ch6Parent)', toolName: 'manage_widget_authoring',
    arguments: { action: 'create_widget_blueprint', name: 'WBP_Ch6Parent', folder: '/Game/DataTest' },
    expected: 'success|already exists' },
  { scenario: 'UMG prep: add canvas panel root (RootCanvas)', toolName: 'manage_widget_authoring',
    arguments: { action: 'add_canvas_panel',
      widgetPath: '/Game/DataTest/WBP_Ch6Parent', slotName: 'RootCanvas' },
    expected: 'success|already exists' },
  { scenario: 'UMG prep: create child WBP class (WBP_Ch6Child)', toolName: 'manage_widget_authoring',
    arguments: { action: 'create_widget_blueprint', name: 'WBP_Ch6Child', folder: '/Game/DataTest' },
    expected: 'success|already exists' },
  { scenario: 'UMG: add_widget (custom BP child under RootCanvas)', toolName: 'manage_widget_authoring',
    arguments: { action: 'add_widget',
      ...
      widgetName: 'Ch6ChildInstance' },
    expected: 'success' },
  { scenario: 'UMG: add_widget (native UTextBlock under RootCanvas, with slotProps)', toolName: 'manage_widget_authoring',
    arguments: { action: 'add_widget',
      widgetBlueprintPath: '/Game/DataTest/WBP_Ch6Parent',
      parentWidgetName: 'RootCanvas',
      widgetClass: 'TextBlock',
      widgetName: 'Ch6NativeText',
      slotProps: { ZOrder: 5, BogusField_ShouldBeSkipped: 'whatever' } },
    expected: 'success' },
  // Ch6 H6.3: U-prefix tolerant short-name lookup ("UTextBlock" -> "TextBlock").
  { scenario: 'UMG: add_widget (U-prefixed short name "UTextBlock" resolves)', toolName: 'manage_widget_authoring',
    arguments: { action: 'add_widget',
      widgetBlueprintPath: '/Game/DataTest/WBP_Ch6Parent',
      parentWidgetName: 'RootCanvas',
      widgetClass: 'UTextBlock',
      widgetName: 'Ch6NativeTextUPrefix' },
    expected: 'success' },
  { scenario: 'UMG: remove_widget (U-prefix test cleanup)', toolName: 'manage_widget_authoring',
    arguments: { action: 'remove_widget',
      widgetBlueprintPath: '/Game/DataTest/WBP_Ch6Parent',
      widgetName: 'Ch6NativeTextUPrefix' },
    expected: 'success' },
  { scenario: 'UMG: get_widget_info after add', toolName: 'manage_widget_authoring',
    arguments: { action: 'get_widget_info', widgetPath: '/Game/DataTest/WBP_Ch6Parent' },
    expected: 'success' },
  { scenario: 'UMG: remove_widget (native TextBlock)', toolName: 'manage_widget_authoring',
    arguments: { action: 'remove_widget',
      widgetBlueprintPath: '/Game/DataTest/WBP_Ch6Parent',
      widgetName: 'Ch6NativeText' },
    expected: 'success' },
  { scenario: 'UMG: remove_widget (missing -> NOT_FOUND)', toolName: 'manage_widget_authoring',
    arguments: { action: 'remove_widget',
      widgetBlueprintPath: '/Game/DataTest/WBP_Ch6Parent',
      widgetName: 'ThisDoesNotExistAnywhere' },
    expected: 'error|not found|NOT_FOUND' },
  ...
  // Ch7: StateTree completion (audit + 7 actions)
  { scenario: 'Ch7 StateTree: create with contextClass', toolName: 'manage_ai',
    arguments: { action: 'create_state_tree', name: 'ST_Ch7Test', path: '/Game/DataTest',
      contextClass: '/Script/GameplayStateTreeModule.StateTreeComponentSchema' },
    expected: 'success|already exists' },
  { scenario: 'Ch7 StateTree: add Combat subtree (top-level)', toolName: 'manage_ai',
    arguments: { action: 'add_state_tree_state', stateTreePath: '/Game/DataTest/ST_Ch7Test',
      stateName: 'Combat', stateType: 'Subtree' },
    expected: 'success|already exists' },
  { scenario: 'Ch7 StateTree: add Patrol child under Root', toolName: 'manage_ai',
    arguments: { action: 'add_state_tree_state', stateTreePath: '/Game/DataTest/ST_Ch7Test',
  ...
  { scenario: 'Ch7 StateTree: add transition Patrol -> Combat (OnEvent)', toolName: 'manage_ai',
    ...
    expected: 'success|not found' },
  { scenario: 'Ch7 StateTree: list states (nested tree)', toolName: 'manage_ai',
    arguments: { action: 'list_state_tree_states', stateTreePath: '/Game/DataTest/ST_Ch7Test' },
    expected: 'success' },
  { scenario: 'Ch7 StateTree: configure selectionBehavior on Root', toolName: 'manage_ai',
    arguments: { action: 'configure_state_tree_task', stateTreePath: '/Game/DataTest/ST_Ch7Test',
      stateName: 'Root', selectionBehavior: 'TrySelectChildrenInOrder' },
    expected: 'success' },
  { scenario: 'Ch7 StateTree: remove Combat subtree', toolName: 'manage_ai',
    arguments: { action: 'remove_state_tree_state', stateTreePath: '/Game/DataTest/ST_Ch7Test',
      stateName: 'Combat' },
    expected: 'success|not found' },
