...
//
// Usage: node tests/task27-native-validation-fixture.mjs [--out <path>]
...
const schemaSubsetTs = readTs('tests/unit/task-27-suite/schema-subset.ts');
const executeReferenceTs = readTs('tests/unit/task-27-suite/execute-reference.ts');
...
const { buildResolverIndex, executeReference } = await import('./unit/task-27-suite/execute-reference.js');
const { minimalValidParams } = await import('./unit/task-27-suite/case-builder.js');
