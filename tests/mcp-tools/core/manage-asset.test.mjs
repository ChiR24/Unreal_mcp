...
// === MATERIAL AUTHORING ACTIONS ===
{
  ...
  testCases.push(
    ...
    { scenario: 'CONFIG: set_material_parameter list ambiguous', toolName: 'manage_asset', arguments: { action: 'set_material_parameter', assetPath: INSTANCE_PATH, parameters: [{ parameterName: 'RoughnessParam', parameterType: 'scalar', value: 0.4 }, { parameterName: 'TintParam', parameterType: 'vector', value: { r: 0.2, g: 0.6, b: 0.9, a: 1 } }] }, expected: 'error|AMBIGUOUS_ACTION' },
    { scenario: 'CREATE: create_material_instance already tinted', toolName: 'manage_asset', arguments: { action: 'create_material_instance', name: `${INSTANCE_NAME}_Tinted`, path: TEST_FOLDER, parentMaterial: MATERIAL_PATH, parameters: [{ parameterName: 'RoughnessParam', parameterType: 'scalar', value: 0.6 }, { parameterName: 'TintParam', parameterType: 'vector', value: { r: 0.1, g: 0.8, b: 0.3, a: 1 } }] }, expected: 'success|already exists' },
