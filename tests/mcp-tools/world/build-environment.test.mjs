...
const testCases = [
  ...
  { scenario: 'CONFIG: configure_sky_light', toolName: 'build_environment', arguments: { action: 'configure_sky_light', actorName: `SkyLight_${ts}`, intensity: 1.5, settings: { SourceType: 0 } }, expected: 'success|already exists|class not found' },
  ...
  { scenario: 'CONFIG: configure_water_waves', toolName: 'build_environment', arguments: { action: 'configure_water_waves', waterBodyName: `Lake_${ts}`, waveHeight: 25, waveLength: 250, amplitude: 0.6, speed: 1.5 }, expected: 'success|not found|class not found' },
