...
const testCases = [
  ...
  { scenario: 'Add foliage type (trees)', toolName: 'build_environment', arguments: { action: 'add_foliage', meshPath: '/Engine/BasicShapes/Cube', density: 0.1 }, expected: 'success - foliage added' },
  ...
  { scenario: 'Create landscape grass type', toolName: 'build_environment', arguments: { action: 'create_landscape_grass_type', name: 'TC_Grass', meshPath: '/Engine/BasicShapes/Cube' }, expected: 'success - grass type created' },
  ...
  { scenario: 'Sculpting - Assign Material', toolName: 'build_environment', arguments: { action: 'set_landscape_material', name: 'TC_Sculpt_Landscape', materialPath: '/Engine/EngineMaterials/DefaultPhysicalMaterial' }, expected: 'success or LOAD_FAILED' },
  ...
  },
  {
    ...
    toolName: "build_environment",
    arguments: { action: "add_foliage", meshPath: "/Valid", density: 0 },
    expected: "success|no_instances|LOAD_FAILED"
  },
  {
