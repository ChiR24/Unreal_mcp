...
// only exist in C++.
//
// Usage: node --loader ts-node/esm tests/adversarial-probes.mjs [--out <path>]
...
import { buildResolverIndex, executeReference } from './unit/gateway-discovery-suite/execute-reference.js';
import { minimalValidParams } from './unit/gateway-discovery-suite/case-builder.js';
