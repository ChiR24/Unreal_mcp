 ...
 * 1,352 canonical records are field-for-field identical on both transports.
 *
 * This gate closes that gap by comparing STRUCTURED DATA for all 1,352 records
...
describe('Task 29 - the full 1,352-record universe exists on every surface', () => {
  it('TypeScript canonical records number exactly 1,352 with unique ids', () => {
  ...
  it('the neutral JSON carries exactly 1,352 full records and a matching recordCount', () => {
  ...
  it('the native shards decode to exactly 1,352 records across 23 per-parent shards', () => {
...
describe('Task 29 - every field of every record is identical on both transports', () => {
  it('all 1,352 TypeScript records equal their neutral-JSON projection field-for-field', () => {
  ...
  it('all 1,352 TypeScript records equal their native shard projection field-for-field', () => {
  ...
  it('both transports agree on both hashes for all 1,352 records', () => {
    const native = readAllNativeShardRecords();
    const neutral = byId(loadNeutral().records);
...
describe('Task 29 - the 23 private parent routes survive intact', () => {
  it('exactly 23 distinct parent tools own the 1,352 records on every surface', () => {
