...
describe('Task 29 - search disclosure stays bounded and deterministic', () => {
  it('an unbudgeted full-catalog browse never approaches the 1,352-record payload', () => {
...
describe('Task 29 - describe discloses progressively and never dumps a union', () => {
  ...
  it('the catalog really is the full 1,352 universe behind these bounded views', () => {
