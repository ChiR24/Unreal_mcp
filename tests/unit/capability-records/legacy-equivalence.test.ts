...
describe('Task 29 - canonical and deprecated legacy client paths normalize identically', () => {
  it('all 1,373 legacy {tool, action} pairs reach a capability or a typed removal', () => {
  ...
  it('the canonical form and the legacy form reach the identical outcome for all 1,373', () => {
    const index = executeTargetIndex();
