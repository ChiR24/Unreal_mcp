// @ts-check
// tests/unit/task-38/parity-harness-native-requirement.mjs
...
// Task38NativeProtocolCaptureTests.cpp runs the native primitive handlers in a
// live editor and the owned runner scripts/qa/task-38-native-capture.mjs stamps
...
export const NATIVE_CAPTURE_REQUIREMENT = Object.freeze({
  ...
  requiredProducer: Object.freeze({
    ...
    source: 'plugins/McpAutomationBridge/Source/McpAutomationBridge/Private/Tests/Task38NativeProtocolCaptureTests.cpp',
    runner: 'scripts/qa/task-38-native-capture.mjs',
  ...
  unblocksWhen:
    'The integration lane builds the plugin, runs scripts/qa/task-38-native-capture.mjs --execute against a serialized UE5.7 editor, and the emitted native-protocol captures pass ground-truth + provenance verification; assertParityReady then opens and compareCaptures runs the exact diff.',
});
