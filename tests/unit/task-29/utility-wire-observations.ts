/**
 * tests/unit/task-29/utility-wire-observations.ts
 *
 ...
 * `task-29-utility-wire-contract.test.ts` re-reads those files and fails if the
 ...
 * `task-29-utility-contract-honesty.test.ts`, not by this fixture.
 *
