...
import {
  ...
  MATRIX_DIMENSIONS,
  REASONS,
} from '../task-38/parity-harness-schema.mjs';
import { checkFixture, compareCaptures, diff } from '../task-38/parity-harness.mjs';
import { staleRevision, toSourceText } from '../task-38/parity-harness-drift.mjs';
...
const TRANSCRIPT = {
  ...
  transcriptRef: 'task-46/native-transcript.jsonl',
