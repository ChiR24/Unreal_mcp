// tests/eval/task48-gate.test.ts
...
// the reviewed ledger in `task48-known-breaches.ts`, which is currently empty,
...
import type { BudgetResult } from './task48-budgets.js';
import {
  knownBreachFor,
  knownBreachIds,
  staleLedgerEntries,
...
import { buildTask48Report, type Task48Report } from './task48-report.js';
import { GATEWAY_DEFAULT_SEARCH_LIMIT, retrievalCases } from './task48-fixtures.js';
import { measurePayload, unionBaselineBytes, jsonBytes } from './task48-measure-payload.js';
import { measureDestructiveAutoSelection, measureRetrieval } from './task48-measure-retrieval.js';
import { describeGatewayCapability } from '../../src/server/gateway/gateway-describe.js';
import { finalRegistryRecords } from './task48-fixtures.js';
