// tests/eval/task48-model-runner.ts
...
import { canonicalIdFor, GATEWAY_DEFAULT_SEARCH_LIMIT, retrievalCases } from './task48-fixtures.js';
import { sha256Canonical } from './hash.js';

export const MODEL_RUNNER_CLIENT = 'task48-model-runner' as const;
