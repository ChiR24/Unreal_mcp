...
static TSharedPtr<FJsonObject> HandleAnimationAuthoringRequest(const TSharedPtr<FJsonObject>& Params)
{
    ...
    // ===== 10.5 Control Rig =====
    // Note: Control Rig functionality has been moved to McpAutomationBridge_ControlRigHandlers.cpp
    // Phase 3F implementation handles this now.
