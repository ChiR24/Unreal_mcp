...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		FMcpSchemaBuilder Schema;
			...
			Schema.Array(TEXT("variableNames"), TEXT("Several variables to give the same metadata in one call (one compile and save), in place of or besides variableName."), TEXT("string"));
