    ...
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
    ...
    {
        SendAutomationError(RequestingSocket, RequestId, TEXT("foliageTypePath required"), TEXT("INVALID_ARGUMENT"));
        return true;
    }
    ...
    {
        SendAutomationError(RequestingSocket, RequestId, TEXT("locations array required"), TEXT("INVALID_ARGUMENT"));
        return true;
    }
    ...
    AsyncTask(ENamedThreads::GameThread, [this, RequestId, FoliageTypePath, Locations, RequestingSocket]()
    {
        ...
        for (const FVector& Location : Locations)
        {
            ...
            {
                // Attempt to register the foliage type, then add
    ...
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
    ...
    AsyncTask(ENamedThreads::GameThread, [this, RequestId, FoliageTypePath, bRemoveAll, RequestingSocket]()
    {
        if (!GEditor || !GEditor->GetEditorWorldContext().World())
        {
            SendAutomationError(RequestingSocket, RequestId, TEXT("Editor world not available"), TEXT("EDITOR_NOT_AVAILABLE"));
    ...
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
    ...
    AsyncTask(ENamedThreads::GameThread, [this, RequestId, FoliageTypePath, RequestingSocket]()
    {
        if (!GEditor || !GEditor->GetEditorWorldContext().World())
        {
            SendAutomationError(RequestingSocket, RequestId, TEXT("Editor world not available"), TEXT("EDITOR_NOT_AVAILABLE"));
    ...
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
    ...
    AsyncTask(ENamedThreads::GameThread, [this, RequestId, Name, MeshPath, Density, MinScale, MaxScale, AlignToNormal, RandomYaw, RequestingSocket]()
    {
        ...
        // Save the asset (UE 5.6: SavePackage signature changed)
